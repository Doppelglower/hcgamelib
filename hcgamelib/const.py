...
OWNER = ['AAfFKK','VEbeHK','coBad2','eYFDHl']
...
unos = [False, [], [], [], "", "+4"]
# [0游戏数据data, 1初始牌组num, 2卡牌列表card, 3剧情词组:通用general, 4剧情词组:预言家prophet, 5剧情词组:狼人werewolf, 6剧情词组:女巫witch]
werewolf=[{"uwu":False}, [1,1,2,3,3,4], {0:{True:"好人",False:"坏人",None:"村长"}, 1:["平民","夜晚：注意旁白 安静等待\n白天：提出意见 跟随大家投票",True], 2:["预言家","夜晚：选择一位村民得知身份\n白天：领导大家投票",True], 3:["狼人","夜晚：选择一位村民杀死\n白天：隐藏身份 跟随大家投票",False], 4:["女巫","夜晚：选择一位村民使用药水 每种药只能使用一次\n白天：隐藏身份 跟随大家投票",False]}, [["选择","决定","打算","想要"],["断了气","没了动静","停了心跳","一命呜呼"],["深夜","半夜三更","凌晨两点","午夜时分"],["失去理智","愤愤不平","闹腾","愤怒"],["绿色","白色","翻折","皱巴巴","缺了角","整齐叠好","黑色","像屎一样"],["收回伸出纸片的手","不知如何抉择","有些迷茫","仔细思考"],["误入","闯入","跳进","来到"],["欺负","诅咒","戏弄","鞭尸"],["飘走了","被偷走了","被捡走了","不翼而飞"]], [["犯了心肌梗塞","脑子不太清醒","撞到了头","摔了一跤"],["叹了口气","沉默不语","喃喃自语","摇了摇头"],["瞪大了双眼","惊掉了下巴","陷入沉思","不敢置信"],["熟","甜","香","舒服"],["没有回应","没有行动","家里没人","不在家中"]], [["惨叫","哀嚎","悲鸣","呜咽"],["四分五裂","难以辨认","被撕咬过","不成样"],["呼唤同伴","追赶","奔走","嬉闹"],["迷路","走丢","离群","去找对象"],["或许是想赌一把","其他狼的想法呢","其他狼赞同吗","真有心机呢"],["做可以吗","真的好吗","是在协助吗","有没有好处"],["伤心欲绝","重情重义","讲义气","悲伤"],["沉思中","略显憔悴","望向远方","不太坚定"]], [["自动写代码","让鱼变好吃","让人变性","压缩纸片"],["死一般的寂静","看似一派祥和","已经没有人影了","偶有远处的呼喊"],["无声","安静","静悄悄","悄无声息"],["大声","狡猾","诡异","阴森"],["想要休息","不知所踪","的纸片丢失了","的小屋无人打扫"]]]
